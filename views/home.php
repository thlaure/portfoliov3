...
<body>
    <div id="title" class="container-fluid py-5 px-md-5 text-center text-white">
        <div class="container row mx-auto">
            ...
            <div class="container">
                <a href="mailto:thomas.laure@ik.me" class="btn btn-light fw-bold mt-3 mb-md-3" id="scroll-contact">ME CONTACTER PAR MAIL</a>
                <div class="row row-cols-auto social my-3">
                    <a href="https://twitter.com/laure_th" class="col-md-1 ms-auto social-media twitter" role="button" title="Twitter">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                            <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z" />
                        </svg>
                    </a>
                    <a href="https://www.reddit.com/user/Merilthor" class="col-md-1 social-media reddit" role="button" title="Reddit">
                    ...
                    <a href="https://www.linkedin.com/in/thomas-laure-ingenieur-developpeur-web/" class="col-md-1 social-media linkedin" role="button" title="LinkedIn">
                    ...
                    <a href="https://github.com/thlaure" class="col-md-1 me-auto social-media github" role="button" title="GitHub">
    ...
    <section class="container-fluid p-5" id="presentation">
        ...
        <div class="row mt-5">
            <div class="col-md-2 center mt-3">
                <img class="rounded shadowing w-100" src="../assets/images/portrait.webp" width="100" alt="Portrait" loading="lazy">
            </div>
            ...
            <article class="col-md-2 mt-3">
                ...
                <ul>
                    ...
                    <li>Informatique</li>
                    <li>Hardware</li>
                    <li>Cinéma / Séries TV</li>
                    <li>Photographie</li>
                    <li>Jeux vidéo</li>
                    <li>Musique</li>
                    <li>Littérature / Philosophie</li>
                    <li>Voyages / Randonnées</li>
                    <li>Moto</li>
                    <li>Sport</li>
            ...
            <article class="col-md-2 mt-3">
                <h3>Soft skills</h3>
                <ul>
                    <li>Permis B / A et véhiculé</li>
                    <li>Ponctualité</li>
                    <li>Créativité</li>
                    <li>Réactivité</li>
                    <li>Rigueur / Flexibilité</li>
                    <li>Curiosité professionnelle</li>
                    <li>Veille technologique</li>
                    <li>Apprentissage continu</li>
                    <li>Organisation / Gestion</li>
                    <li>TOEIC : 845 points</li>
                    <li>Certificat Voltaire : <a href="https://www.certificat-voltaire.fr/orthographe-recruteur">771 points</a></li>
                </ul>
            </article>
        </div>
        <div class="mt-5 text-center">
            <a href="../assets/docs/cv_thomas_laure.pdf" class="button animated-corners fw-bold p-4">Télécharger mon CV</a>
        </div>
    </section>
                ...
                <div class="col-lg-7 mx-auto">
                    <ul class="timeline">
                        <li class="timeline-item bg-white rounded ms-3 p-4 shadow">
                            ...
                            <span class="small text-gray">Septembre 2021 - Aujourd'hui</span>
                        ...
                        <li class="timeline-item bg-white rounded ms-3 p-4 shadow">
                            ...
                            <span class="small text-gray">Février 2021 - Aujourd'hui</span>
                        ...
                        <li class="timeline-item bg-white rounded ms-3 p-4 shadow">
                            ...
                            <span class="small text-gray">Septembre 2018 - Août 2021</span>
                        ...
                        <li class="timeline-item bg-white rounded ms-3 p-4 shadow">
                            ...
                            <span class="small text-gray">Juillet 2018 - Novembre 2018</span>
                        ...
                        <li class="timeline-item bg-white rounded ms-3 p-4 shadow">
                            ...
                            <span class="small text-gray">Septembre 2016 - Juin 2018</span>
                        ...
                        <li class="timeline-item bg-white rounded ms-3 p-4 shadow">
                            ...
                            <span class="small text-gray">Septembre 2015 - Avril 2016</span>
                        ...
                        <li class="timeline-item bg-white rounded ms-3 p-4 shadow">
                            ...
                            <span class="small text-gray">Septembre 2012 - Juin 2015</span>
